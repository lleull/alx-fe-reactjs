function UserProfile() {
  return (
    <div className="bg-gray-100 sm:p-4 md:p-8 sm:max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      />
      <h1
        className="sm:text-lg md:text-xl text-blue-800 hover:text-blue-500 my-4 text-center transition-colors duration-300"
      >
        John Doe
      </h1>
      <p
        className="sm:text-sm md:text-base text-gray-600 text-center"
      >
